...
class GuessingGame(EasyFrame):
	...
	def __init__(self):
		...
		self.hintLabel = self.addLabel(text = "Guess a Number between 1 and 10", row = 0, column = 0, columnspan = 2, sticky = "NESW")
